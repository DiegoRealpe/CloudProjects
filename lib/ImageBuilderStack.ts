...
export class ImageBuilderStack extends cdk.Stack {
  ...
  private createImagePipeline(): imagebuilder.CfnImagePipeline {
    ...
    try {
      const pipeline = new imagebuilder.CfnImagePipeline(this, 'ec2ImagePipeline', {
        ...
        distributionConfigurationArn: undefined, //this.distributionConfig.attrArn,
  ...
  private buildRecipe(): imagebuilder.CfnImageRecipe {
    ...
    const ssmComponent = new imagebuilder.CfnComponent(this, 'NonSSMAgentComponent', {
      name: 'NonInstallSSMAgent',
      platform: 'Linux',
      version: '1.0.0',
      description: 'NOES NOT Installs the AWS Systems Manager Agent (SSM Agent).',
    ...
    const recipe = new imagebuilder.CfnImageRecipe(this, 'javaImageRecipe', {
      ...
      additionalInstanceConfiguration: {
        ...
        // userDataOverride: fs.readFileSync('./assets/userData.sh').toString('base64'),
      },
